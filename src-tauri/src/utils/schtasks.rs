...
const TASK_NAME_USER: &str = "RedClash";
const TASK_NAME_ADMIN: &str = "RedClash (Admin)";
const TASK_XML_DIR: &str = "tasks";
const TASK_XML_USER: &str = "red-clash-task-user.xml";
const TASK_XML_ADMIN: &str = "red-clash-task-admin.xml";
...
async fn cleanup_legacy_shortcuts() -> Result<()> {
    ...
    let new_shortcut = startup_dir.join("RedClash.lnk");
