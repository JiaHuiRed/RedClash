...
pub static APP_ID: &str = "io.github.QiuYeDeng.red-clash";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "red-clash-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "io.github.QiuYeDeng.red-clash.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "red-clash-backup-dev";
...
pub fn service_path() -> Result<PathBuf> {
    ...
    Ok(res_dir.join("red-clash-service"))
}

#[cfg(windows)]
pub fn service_path() -> Result<PathBuf> {
    let res_dir = app_resources_dir()?;
    Ok(res_dir.join("red-clash-service.exe"))
}
